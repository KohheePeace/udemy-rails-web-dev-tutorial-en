...
Running via Spring preloader in process 79687
      create  db/migrate/20191203195016_create_friendly_id_slugs.rb
      create  config/initializers/friendly_id.rb
```

`db/migrate/20191203195016_create_friendly_id_slugs.rb`
```ruby
MIGRATION_CLASS =
