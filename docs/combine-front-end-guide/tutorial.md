...
```
mkdir bootstrap-combine-demo
cd bootstrap-combine-demo
touch index.html
```
...
move `status update` image under `img` folder and rename it.
![move-status-update-and-rename](../img/combine-front-end-guide/move-status-update-and-rename.png)

Add `img tag` to right side of jumbotron
```html
<div class="jumbotron bg-primary">
  <div class="row">
    <div class="col-md-6">
...
## About Us Section
There is nothing special in About Us section.
...
==You can check How order class works by using google dev tools.==
...
### Edit the code to see how it works
...
### Change img src url and Add border-bottom
