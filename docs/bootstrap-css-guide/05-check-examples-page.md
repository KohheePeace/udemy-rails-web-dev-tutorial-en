...
![bootstrap-examples-page](../img/bootstrap-css-guide/bootstrap-examples-page.gif)
...
![album-example-demo.gif](../img/bootstrap-css-guide/album-example-demo.gif)


## Copy all source code
![copy-album-code](../img/bootstrap-css-guide/copy-album-code.gif)
...
![album-example-not-working.png](../img/bootstrap-css-guide/album-example-not-working.png)

## Check the bug

Please open google dev tools and click `console` tab.

![check-console-error.gif](../img/bootstrap-css-guide/check-console-error.gif)
...
![how-to-search-bug.gif](../img/bootstrap-css-guide/how-to-search-bug.gif)
...
![album-example-fix-step1.png](../img/bootstrap-css-guide/album-example-fix-step1.png)

### Step2 `GET file:///Users/kohheepeace/Code/asobi/html-playground/album.css net::ERR_FILE_NOT_FOUND`
Make `album.css`
![make-album-css.gif](../img/bootstrap-css-guide/make-album-css.gif)

![copy-album-css.gif](../img/bootstrap-css-guide/copy-album-css.gif)
...
Check output...
![check-output-after-album-css.png](../img/bootstrap-css-guide/check-output-after-album-css.png)
